            ...
            <div class="container mx-auto px-4">
                        ...
                        >
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <p class="mt-2 mb-4 text-blueGray-500">
                                    We speak Thai & English and want to share
                                    the good news with you!
                                </p>
                                <p class="mt-2 mb-4 text-blueGray-500">
                                    Proverbs 25:13: "Like a snow-cooled drink at
                                    harvest time is a trustworthy messenger to
                                    the one who sends him; he refreshes the
                    ...
                    <div class="w-full md:w-4/12 px-4 text-center">
                        ...
                        >
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">God First</h6>
                                <p class="mt-2 mb-4 text-blueGray-500">
                                    Put God first in your life and let's walk in
                                    faith together.
                                </p>
                                <p class="mt-2 mb-4 text-blueGray-500">
                    ...
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        ...
                        >
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <p class="mt-2 mb-4 text-blueGray-500">
                                    Song of Solomon 8:6-7: "Place me like a seal
                                    over your heart, like a seal on your arm;
                                    for love is as strong as death, its jealousy
                                    unyielding as the grave. It burns like
                                    blazing fire, like a mighty flame. Many
                                    waters cannot quench love; rivers cannot
                                    sweep it away."
                                </p>
                            </div>
                        </div>
                ...
                <div class="flex flex-wrap items-center mt-32">
                    <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                        ...
                        >
                            Father's Business is coming back to Thailand 2025!
                            We are super excited to be back in Bangkok soon.
                        </p>
                        <p
                    ...
                    <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                        ...
                        >
                            <img
                                alt="..."
                                src="https://images.unsplash.com/photo-1508009603885-50cf7c579365?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1051&q=80"
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-wrap justify-center text-center mb-24">
                    <div class="w-full lg:w-6/12 px-4">
                        <h2 class="text-4xl font-semibold">Jeremiah 29:11</h2>
                        <p
