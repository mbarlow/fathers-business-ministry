    ...
    <main>
        ...
        >
            <div
                ...
                style="
          background-image: url('/src/assets/fb.jpg');
        "
            >
                <span
                    id="blackOverlay"
                    ...
                    >
                        ...
                        >
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">America</h6>
                    ...
                    <div class="w-full md:w-4/12 px-4 text-center">
                        ...
                        >
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <h6 class="text-xl font-semibold">Thailand</h6>
                                <p class="mt-2 mb-4 text-blueGray-500">
                    ...
                    <div class="pt-6 w-full md:w-4/12 px-4 text-center">
                        ...
                        >
                            <div class="px-4 py-5 flex-auto">
                                ...
                                <p class="mt-2 mb-4 text-blueGray-500">Yes</p>
                            </div>
                        </div>
                    </div>
                </div>
